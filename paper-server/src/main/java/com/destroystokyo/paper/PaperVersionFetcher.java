...
public class PaperVersionFetcher implements VersionFetcher {
    ...
    private static final String DOWNLOAD_PAGE = "https://github.com/ReflintMC/Reflint/releases";
    ...
    public Component getVersionMessage(final String serverVersion) {
        ...
        if (build.buildNumber().isEmpty() && build.gitCommit().isEmpty()) {
            ...
            updateMessage = getUpdateStatusMessage("ReflintMC/Reflint", build);
        }
    ...
    private static int fetchDistanceFromSiteApi(final ServerBuildInfo build, final int jenkinsBuild) {
        try {
            try (final BufferedReader reader = Resources.asCharSource(
                URI.create("https://api.papermc.io/v2/projects/reflint/versions/" + build.minecraftVersionId()).toURL(),
                Charsets.UTF_8
            ).openBufferedStream()) {
